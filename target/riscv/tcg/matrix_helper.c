...
MMEXT_LD_ELEM(ld_h, ldsw_le)
MMEXT_LD_ELEM(ld_w, ldl_le)
MMEXT_LD_ELEM(ld_d, ldq_le)
...
MMEXT_ST_ELEM(st_h, stw_le)
MMEXT_ST_ELEM(st_w, stl_le)
MMEXT_ST_ELEM(st_d, stq_le)
